...
#define E0_STOP_PIN                         PC15  // E0-STOP

#ifndef I_MIN_PIN
  #define I_MIN_PIN   E0_STOP_PIN   // I 轴最小端口 = E0-STOP
#endif
//
...
// TMC UART 通信映射 (E0 → I 轴)
  ...
  #define I_HARDWARE_SERIAL E0_HARDWARE_SERIAL   // 关键：复用 E0 通信通道
#endif